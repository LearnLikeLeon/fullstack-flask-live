# This will be a single file that will handle all the backend :
...
# Let's define the model and the name of the table in the database :
class User(db.Model):
  __tablename__ = 'users'
  ...
  # Let;s define a json file for the model : 
  def json(self):
